...
const Header: React.FC = () => {
  ...
  // Show loading state if we're still fetching user data
        ...
        <div className="flex items-center space-x-2 md:space-x-4">
          {isAuthenticated ? (
            ...
            <Button 
              ...
              className="bg-primary hover:bg-primary/90 flex items-center space-x-2 text-sm md:text-base px-3 md:px-4 py-2"
            >
