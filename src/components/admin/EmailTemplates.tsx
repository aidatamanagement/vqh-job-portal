...
const EmailTemplates: React.FC = () => {
  ...
  const fetchTemplates = async () => {
    ...
    try {
      ...
      console.log('Templates fetch response:', { data, error });
      ...
      setError(`Failed to fetch templates: ${errorMessage}`);
      toast({
        title: "Error",
        ...
        {templates.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-400 mb-4">
              Email templates should be automatically created when the system initializes.
            </p>
            <Button onClick={fetchTemplates}>
              <RefreshCw className="w-4 h-4 mr-2" />
              Check Again
