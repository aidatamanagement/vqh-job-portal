-- Minimal fix: Just update the function to return tracking_token needed for emails
-- Everything else in the database is already correct
...
BEGIN
  ...
  SELECT 
    jsonb_build_object(
      ...
      'tracking_token', ja.tracking_token,  -- ✅ ADDED THIS - needed for emails
...
'Updates application status with mandatory notes and logs the change in status_history. Fixed to include tracking_token for email automation.';